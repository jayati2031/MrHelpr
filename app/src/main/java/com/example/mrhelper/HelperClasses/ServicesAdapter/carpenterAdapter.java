...
public class carpenterAdapter extends RecyclerView.Adapter<carpenterAdapter.ViewHolder> implements Adapter {

    List<String> mName, mPhoneNo, mAddress, mHours, mImage;
    LayoutInflater inflater;

    public carpenterAdapter(Context context, List<String> mName, List<String> mPhoneNo, List<String> mAddress, List<String> mHours, List<String> mImage){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_recycler_carpenter,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            phoneNo = itemView.findViewById(R.id.phone_no3);
            address = itemView.findViewById(R.id.address3);
            hours = itemView.findViewById(R.id.hours3);
            thumbnail = itemView.findViewById(R.id.cardImg3);

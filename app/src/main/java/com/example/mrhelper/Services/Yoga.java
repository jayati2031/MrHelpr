...
import com.example.mrhelper.HelperClasses.ServicesAdapter.yogaAdapter;
...
public class Yoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerView18);
        progressBar = findViewById(R.id.yoga_prog);
        backBtn = findViewById(R.id.back_pressed);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Yoga.super.onBackPressed();
            }
        });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Yoga.this));
        adapter = new yogaAdapter(Yoga.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("yoga.xls");

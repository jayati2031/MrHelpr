...
import com.example.mrhelper.HelperClasses.ServicesAdapter.homecleanerAdapter;
...
public class HomeCleaner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.home_prog);
        backBtn = findViewById(R.id.back_pressed);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HomeCleaner.super.onBackPressed();
            }
        });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(HomeCleaner.this));
        adapter = new homecleanerAdapter(HomeCleaner.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("home_cleaner.xls");

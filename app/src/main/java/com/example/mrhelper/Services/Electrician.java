...
import com.example.mrhelper.HelperClasses.ServicesAdapter.electricianAdapter;
...
public class Electrician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Electrician.super.onBackPressed();
            }
        });
        ...
        adapter = new electricianAdapter(Electrician.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("electrician.xls");

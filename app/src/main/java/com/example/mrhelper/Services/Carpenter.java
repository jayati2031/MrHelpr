...
import com.example.mrhelper.HelperClasses.ServicesAdapter.carpenterAdapter;
...
public class Carpenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.carp_prog);
        backBtn = findViewById(R.id.back_pressed);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Carpenter.super.onBackPressed();
            }
        });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Carpenter.this));
        adapter = new carpenterAdapter(Carpenter.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("carpenter.xls");

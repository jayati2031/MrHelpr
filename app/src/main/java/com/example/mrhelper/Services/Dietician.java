...
import com.example.mrhelper.HelperClasses.ServicesAdapter.dieticianAdapter;
...
public class Dietician extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.diet_prog);
        backBtn = findViewById(R.id.back_pressed);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dietician.super.onBackPressed();
            }
        });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Dietician.this));
        adapter = new dieticianAdapter(Dietician.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("dietician.xls");

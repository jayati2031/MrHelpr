...
public class Physiotherapy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerView16);
        progressBar = findViewById(R.id.physio_prog);
        backBtn = findViewById(R.id.back_pressed);

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Physiotherapy.super.onBackPressed();
            }
        });
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Physiotherapy.this));
        adapter = new physiotherapyAdapter(Physiotherapy.this, pName, pPhoneNo, pAddress, pHours, pImages);
    ...
    public void startXLFileReading(){
        try {
            ...
            InputStream is = am.open("physiotherapy.xls");
